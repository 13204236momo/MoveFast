...
package com.example.administrator.movefast.qrcode.camera;
...
public final class CameraManager {
	...
	public interface onCameraConfigChangedListener {
	...
	private CameraManager(Context context) {
		...
		useOneShotPreviewCallback = android.os.Build.VERSION.SDK_INT > 3; // 3 = Cupcake
	 ...
	 */
	public void openDriver(SurfaceHolder holder, onCameraConfigChangedListener listeneer) throws IOException {
		if (camera == null) {
			camera = Camera.open();
			if (camera == null) {
			...
			configManager.setDesiredCameraParameters(camera,listeneer);
	...
	public Rect getFramingRect() {
		...
		if (framingRect == null) {
			...
			int width = Helper.dip2px(200);
			if (width < MIN_FRAME_WIDTH) {
				width = MIN_FRAME_WIDTH;
			} else if (width > MAX_FRAME_WIDTH) {
				width = MAX_FRAME_WIDTH;
			}
			int height = Helper.dip2px(200);

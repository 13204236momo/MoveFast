package com.example.administrator.movefast.utils.logger;
...
public final class Logger {
	...
	public static void EmtyViewBugMessage(String message) {
		e("EVBug", message, null, settings.methodCount);
	}
...
//        logChunk(logType, tag, TOP_BORDER);
	...
	private static void logHeaderContent(int logType, String tag, int methodCount) {
		if (methodCount > 0 || settings.showThreadInfo)
			logChunk(logType, tag, "__________________________________________________________________________________");

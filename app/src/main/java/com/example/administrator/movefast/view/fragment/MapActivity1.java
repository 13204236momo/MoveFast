...
import com.example.administrator.movefast.view.controller.MapController1;
...
public class MapActivity1 extends AppCompatActivity {
    ...
    private AMap aMap;
    private MapController1 mapController;
    ...
    private void initMap(Bundle savedInstanceState) {
        ...
        //地图设置相关
        mapController = new MapController1(this,aMap);
